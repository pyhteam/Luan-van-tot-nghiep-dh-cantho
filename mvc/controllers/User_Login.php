...
//                header('location: index.php?url=User_Login/login');
        ...
        //    die();
            ...
            if($_POST['khoa']==""){
                $test_validate = true;
                array_push($error['khoa'],'Vui lòng nhập tên Trường / Khoa');
            }else{
                $result_old['khoa'] = $_POST['khoa'];
            }
            ...
            if($test_validate){
                ...
                if($_POST['password'] != $_POST['password_confirm']){
                    ...
                    $khoa = $_POST['khoa'];
                    $result = json_decode($this->user->insert($user_name,$full_name,$email,$phone,$country,$conscious,$district,$commune,$address_detail,$password,$created_at,$updated_at, $ma_lop,$nganh,$ngay_sinh,$khoa));
                    if($result){
                        $this->view('frontend/login/login',[
