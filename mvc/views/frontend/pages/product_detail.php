<div class="" style="margin-top: 110px;"></div>
    ...
    <div class="container-cover">
        <div class="row mt-5">
            ...
            <div class="col-xl-7 col-lg-6 ">
                ...
                <div>
                    <p> 
                        <a href="./public/uploads/<?php echo $data['product_detail']->pdf; ?>" target="_blank"> Xem chi tiết kế hoạch</a>
                    </p>
                    <a href="index.php?url=Cart/checkout/<?php echo $data['product_detail']->id; ?>" target="_blank" style="color: blue;"> Đăng ký tại link này</a>
                </div>
                ...
                <div class="tab-pane fade show active" id="nav-profile" role="tabpanel" aria-labelledby="nav-profile-tab">
                    <?php 
                        if(isset($data['list_comment'])){
                            foreach($data['list_comment'] as $comment){ ?>
                        <div class="comment-item mb-3">
                        <div class="row">
                            <div class="col-sm-1">
                                <div class="comment-img pr-xl-0 pr-lg-2 pr-2">
                                    <img src="./public/uploads/<?php echo $comment->image ?>" alt="">
                                </div>
                            </div>
                            <div class="col-sm-11">
                                <div class="comment-content pl-4">
                                    <p class="user_name"><?php echo $comment->user_name ?></p>
                                    <p class="user_comment"><?php echo $comment->content ?></p>
                    ...
                    <!-- <div >
                        ...
                        <form action="index.php?url=CommentPro/store" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <input type="hidden" name="pro_id" value="<?php echo $data['product_detail']->id ?>" />
