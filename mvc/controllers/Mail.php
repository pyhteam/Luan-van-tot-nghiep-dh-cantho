    ...
    class Mail extends Controller{
        public function sendMail(){
            ...
            try {
                ...
                $mail->Port       = 465;                                    //TCP port to connect to; use 587 if you have set `SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS`
                                                                            //465 <=> 587
                //Recipients
                $mail->setFrom('duyenb1910046@student.ctu.edu.vn', 'Admin');
        ...
        public function sendMail_Order($order_info){
            ...
            try {
                ...
                $mail->isHTML(true);                                  //Set email format to HTML
                $mail->Subject = 'Thông tin đăng ký '.$order_info['full_name'];
                $mail->Body    = '<!DOCTYPE html>
                <html lang="en">
                    <head>
                        <meta charset="UTF-8">
                                                            ...
                                                            <tbody>
                                                                <tr style="margin:0;padding:0">
                                                                    <td style="margin:0;padding:0 0 24px;border-bottom:2px solid #b49763">
                                                                        <a style="color: #000; text-decoration: none" href="http://localhost/Composer2_pdf/index.php">HỆ THỐNG QUẢN LÝ TRAO ĐỔI SINH VIÊN ĐI NƯỚC NGOÀI</a> 
                                                                    </td>
                                                                </tr>
                                                                <tr style="margin:0;padding:0">
                                                                ...
                                                                <tr style="margin:0;padding:0">
                                                                    <td
                                                                        ...
                                                                        Chúc mừng bạn<strong
                                                                            style="margin:0;padding:0;font-size:16px;font-weight:bold"><?php echo $order_info["full_name"] ?></strong>. Bạn đã đăng ký online thành công
                                                                    </td>
                                                                </tr>
                                                                <tr style="margin:0;padding:0">
                                                                    <td style="height:8px;margin:0;padding:0;font-size:0;line-height:0">
                                                                ...
                                                                <tr style="margin:0;padding:0">
                                                                    <td
                                                                        ...
                                                                        <div style="text-align:center"> <a
                                                                            ...
                                                                            ">Kiểm tra lại thông tin bạn đã đăng ký</button></a> 
                                                                        </div>
                                                                    </td>
                                                                </tr>
                                                            </tbody>
