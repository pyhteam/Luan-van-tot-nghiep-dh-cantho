            ...
            <div class="row">
                <div class="col-sm-8 offset-sm-2">
                    ...
                    <form action="index.php?url=User_Login/post_login" method="POST" class="border_form">
                        <h2 class="text-center mb-4" style="color:black;font-weight: bold;">Đăng nhập</h2>
                        <?php
                        ...
                        <div class="text-center">
                            <button type="submit" class="btn2 btn_login btn-primary mr-4" style="background-color: blue;">Đăng nhập</button>
                ...
                <div class="container">
                    <p class="text-center"><a href="index.php?url=Home/index" target="_parent" style="color:black; font-weight: bold;"> <br>Trở về trang chủ </a></p>
                </div>
            </div>
        </div>
    </div>
