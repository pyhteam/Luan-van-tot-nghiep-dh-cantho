...
//                die();
                ...
                //5.1 thời gian
                $error['thoi_gian'] = array();
                if(!isset($_POST['thoi_gian']) || $_POST['thoi_gian']==""){
                    array_push($error['thoi_gian'],"Vui lòng nhập thời gian của chương trình");
                    $test_validate = true;
                }else{
                    $result_old['thoi_gian'] = $_POST['thoi_gian'];
                }
                ...
                if($test_validate == false){
                    ...
                    // table product_image----
                    $allowTypes = array('jpg','png','jpeg','gif','image/jpeg', 'pdf');
                    $path = "public/uploads/";
