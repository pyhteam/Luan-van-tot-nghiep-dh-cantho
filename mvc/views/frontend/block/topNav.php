<div id="header1">
    <nav  class="navbar navbar-expand-lg navbar-light bg-light position-fixed fixed-top px-5" style="box-shadow: 0 0 10px rgba(0,0,0,0.3);">
        <a href="index.php" class="navbar-brand" href="#"><img src="./public/frontend/images/logo_cit.png" alt="" style="width: 80px;"></a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item nav_item_down"> 
                    <a class="nav-link" href="index.php?url=Home/product">Chương trình<span><i class="fa fa-chevron-down icon_navbar" aria-hidden="true"></i></span>
                ...
                <!--
                <li class="nav-item">
                    <a class="nav-link" href="index.php?url=Home/form">Biểu mẫu</a>
                </li>
                 -->
                <!-- Liên hệ -->
                <!-- <li class="nav-item"> 
                    <a class="nav-link" href="index.php?url=Home/contact">Hợp tác</a>
                </li> -->
                <!-- </li> -->
                 <li class="ml-4" style="position: relative;">
                    <form method="POST" action="index.php?url=Home/search_product">
                        <div class="input-group" style="width: 200px;">
                            <input type="text" id="search_key" name="search_key" class="form-control" placeholder="Tìm kiếm...">
                            <span class="input-group-btn">
                            <button type="submit" class="btn btn-default ml-2" type="button" style="background-color: #0000FF;">Tìm</button>
                            </span>
                        </div>
                    </form>
                </li>       
            ...
            <ul class="nav-list-icon" style="list-style: none;">
                ...
                <li><a href="" style="position: relative;" class="fa fa-bell"></a><span class="quantity"></span></li>
            </ul>
