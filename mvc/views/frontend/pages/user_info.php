...
<!-- <div class="container-fluid mb-5" style="background: #fef5ef!important;">
    <div class="jumbotron jumbotron-fluid" style="background: #fef5ef!important;" >
        <div class="container">
            ...
            <p class="text-center"><a class="text-link1" href="index.php?url=Home/index">Home</a> > Thông tin cá nhân</p>
        </div>
    </div>
</div> -->
    ...
    <div class="container-cover container-cover-cart">
        ...
        <form action="index.php?url=Home/update_user_info" method="POST" enctype="multipart/form-data" class="border_form">
            <div class="row">
                <div class="col-sm-8">
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label for="exampleInputEmail1">MSSV (User name )<span class="text-danger">*</span></label>
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label for="exampleInputEmail1">Lớp <span class="text-danger">*</span></label>
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="khoa" value="<?php echo isset($data['user_login']->khoa)?$data['user_login']->khoa:""; ?>" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
                                <span class="text-danger" style="font-size: 14px;"></span>
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="ngay_sinh" value="<?php echo isset($data['user_login']->ngay_sinh)?$data['user_login']->ngay_sinh:""; ?>" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
                                <span class="text-danger" style="font-size: 14px;"></span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label for="exampleInputEmail1">Phường/Xã/Thị xã <span class="text-danger">*</span></label>
            ...
            <div class="cover_img_user mx-auto">
                ...
                <div class="ml-5">
                    <button type="submit" class="btn text-white">Cập nhật</button>
                </div>
            </div>
            </div>
        </div>
